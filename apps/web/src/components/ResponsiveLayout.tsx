...
export default function ResponsiveLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden relative">
      ...
      <div 
        className="hidden md:block shrink-0 relative group h-screen"
        style={{ 
      ...
      {!isCollapsed && (
        <div 
          className={`hidden md:block w-[5px] cursor-col-resize hover:bg-indigo-500/50 transition-colors relative group/handle shrink-0 z-30 ${
        ...
        >
          ...
          <button
            ...
            className="absolute left-1/2 -translate-x-1/2 top-4 opacity-0 group-hover/handle:opacity-100 hover:opacity-100! p-1 rounded-full border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-md hover:bg-zinc-100 dark:hover:bg-zinc-900 text-zinc-550 hover:text-zinc-850 dark:text-zinc-400 dark:hover:text-zinc-200 transition-opacity cursor-pointer flex items-center justify-center z-30"
